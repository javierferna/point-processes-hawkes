...
The ultimate goal is to **compare the fitted Hawkes process parameters ($\mu$, $\alpha$, $\beta$) across clusters**. This allows us to understand how event risk and self-excitation patterns differ between patient subgroups.
